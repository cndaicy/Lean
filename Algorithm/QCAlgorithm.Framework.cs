...
namespace QuantConnect.Algorithm
{
    ...
    public partial class QCAlgorithm
    {
        ...
        public void EmitInsights(params Insight[] insights)
        {
            ...
            OnInsightsGenerated(insights.Select(insight =>
            {
        ...
        {
            var bridgeAlgorithm = GetType() == typeof(QCAlgorithmFrameworkBridge)
                || GetType().IsSubclassOf(typeof(QCAlgorithmFrameworkBridge));
